...
exp1 <- read_excel("data.xlsx", sheet = 3) 
...
exp2 <- read_excel("data.xlsx", sheet = 3) 
...
exp3 <- read_excel("data.xlsx", sheet = 3) 
exp3 <- exp3 %>%
...
exp4 <- read_excel("data.xlsx", sheet = 3) 
exp4 <- exp4 %>%
...
set.seed(42)
(roctest1 <- roc.test(ROC_gbm_exp1, ROC_gbm_noperf_exp1, method="venkatraman", boot.n = 2000, paired = TRUE))
set.seed(42)
(roctest2 <- roc.test(ROC_gbm_exp2, ROC_gbm_noperf_exp2, method="venkatraman", boot.n = 2000, paired = TRUE))
set.seed(42)
(roctest3 <- roc.test(ROC_gbm_exp3, ROC_gbm_noperf_exp3, method="venkatraman", boot.n = 2000, paired = TRUE))
set.seed(42)
(roctest4 <- roc.test(ROC_gbm_exp4, ROC_gbm_noperf_exp4, method="venkatraman", boot.n = 2000, paired = TRUE))
...
sprintf("Statistic: %.3f", roctest1$p.value)
...
sprintf("Statistic: %.3f", roctest2$p.value)
...
sprintf("Statistic: %.3f", roctest3$p.value)

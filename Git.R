...
exp1 <- read_excel("results_plan3.xlsx", sheet = 3) 
...
exp2 <- read_excel("results_plan3.xlsx", sheet = 3) 
...
exp3 <- read_excel("results_plan3.xlsx", sheet = 3) 
exp3 <- exp3 %>%
...
roc22 <- plot(ROC_gbm_exp1)
roc22 <- smooth(ROC_gbm_exp1)
...
roc23 <- smooth(ROC_gbm_noperf_exp1)
...
roc1 <- plot(ROC_gbm_exp2)
roc1 <- smooth(ROC_gbm_exp2, method = "density")
...
roc2 <- smooth(ROC_gbm_noperf_exp2)
...
roc8 <- smooth(ROC_gbm_noperf_exp3)
...
roc14 <- smooth(ROC_gbm_noperf_exp4)
...
sprintf("Statistic: %.3f", roctest13$p.value)
...
sprintf("Statistic: %.3f", roctest4$p.value)
...
sprintf("Statistic: %.3f", roctest7$p.value)
...
sprintf("Statistic: %.3f", roctest10$p.value)
...
plot.window(xlim = c(0, 1), ylim = c(-0.2, 1),
            xaxs = "i", yaxs="i")
plot(roc22, col=1, lty=1, lwd=3, cex.axis=1.5, cex.lab=1.5)
plot(roc23, col=4, lty=3, lwd=3, add=TRUE, cex.axis=1.5, cex.lab=1.5)
...
plot(roc13, col=1, lty=1, lwd=3, cex.axis=1.5, cex.lab=1.5)
plot(roc14, col=4, lty=3, lwd=3, add=TRUE, cex.axis=1.5, cex.lab=1.5)
